...
public class MyDialog extends DialogFragment {
    ...
    private Dialog getUpdateClassDialog() {
        ...
        EditText course_edt = view.findViewById(R.id.edt01);
        EditText section_edt = view.findViewById(R.id.edt02);

        course_edt.setHint("Course Title");
        section_edt.setHint("Section Number");
        Button cancel = view.findViewById(R.id.cancel_btn);
        Button add = view.findViewById(R.id.add_btn);
        add.setText("Update");
        ...
        add.setOnClickListener(v -> {
            ...
            String sectionNumber = section_edt.getText().toString();
            listener.onClick(course,sectionNumber);
            dismiss();
        });
        return builder.create();
    }
